...
return	array(	
	'system'=>array('name'=>'系统','child'=>array(
				...
				array('name' => '会员','child'=>array(
						...
						array('name'=>'会员服务','act'=>'server','op'=>'User'),

						array('name'=>'分红点','act'=>'fenghong_points','op'=>'User'),

						array('name'=>'日志记录','act'=>'fenhong_log','op'=>'User'),

						array('name'=>'会员关系','act'=>'user_guanxi','op'=>'User'),

						// array('name'=>'团队业绩图','act'=>'user_group','op'=>'User'),
						
						array('name'=>'分红点每周返','act'=>'every_week_return','op'=>'User'),
						
						array('name'=>'激活分红点每周返','act'=>'every_week_return_active','op'=>'User'),
                  
                  		array('name'=>'报单币出入详情','act'=>'tongji_baodanbi','op'=>'User'),
