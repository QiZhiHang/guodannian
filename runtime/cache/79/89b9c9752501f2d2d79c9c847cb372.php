<?php
//000000000000s:69574:"<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>商品详情</title>
...
<div class="details-bigimg p">
    <div class="w1224">
            ...
            <div class="product-gallery">
                <div class="product-photo" id="photoBody">
                    ...
                    <div class="product-img jqzoom">
                        <img id="zoomimg" src="/public/upload/goods/thumb/147/goods_thumb_147_400_400.jpeg" jqimg="/public/upload/goods/thumb/147/goods_thumb_147_800_800.jpeg">
                    </div>
                    <!-- 商品大图介绍 end ]]-->
                    <!-- 商品小图介绍 start [[-->
                ...
                <div class="share">
                    ...
                    <script>
                        var jiathis_config = {
                            url:"http://www.newtpshop.com/index.php?m=Home&c=Goods&a=goodsInfo&id=147",
                            pic:"http://www.newtpshop.com/public/upload/goods/thumb/147/goods_thumb_147_400_400.jpeg",
                        }
        ...
        <form id="buy_goods_form" name="buy_goods_form" method="post" >
            ...
            <input type="hidden" name="store_count" value="98"/><!-- 活动库存 -->
            <input type="hidden" name="market_price" value="3000.00"/><!-- 商品原价 -->
                ...
                <div class="shop-price-cou">
                    <div class="shop-price-le">
                        ...
                        <ul>
                            ...
                            <li class="though-line"><span><em>￥</em><span id="market_price">3000.00</span></span></li>
                        </ul>
                ...
                <div class="standard">
                    <ul class="p">
                        ...
                        <li class="lawir">
                            ...
                            <div class="sav_shop">库存：<span id="spec_store_count">98</span></div>
                        </li>
                    </ul>
                </div>
                <div class="standard p">
                    <input type="hidden" name="goods_id" value="147" />
                    <a id="join_cart_now" class="paybybill" href="javascript:;" onclick="AjaxAddCart(147,1,1);">立即购买</a>
                    <a id="join_cart" class="addcar" href="javascript:;" onclick="AjaxAddCart(147,1,0);"><i class="sk"></i>加入购物车</a>
            ...
            <div class="introduceshop">
                ...
                <div class="shop-describe shop-con-describe p">
                    <div class="deta-descri">
                        <p class="shopname_de"><span>商品名称：</span><span>【商城推荐】小洞仙53度吉尼斯官方推荐</span></p>
                        <div class="ma-d-uli p">
                            <ul>
                                <!--<li><span>品牌：</span><span></span></li>-->
                                <li><span>货号：</span><span>TP0000147</span></li>
                                                            </ul>
                        </div>
                    ...
                    <div class="detail-img-b">
                        <p><img src="/public/upload/temp/2017/09-19/cdcbe79fe389ab61b7f2c4b5fe614705.jpeg" title="cdcbe79fe389ab61b7f2c4b5fe614705.jpeg" alt="cdcbe79fe389ab61b7f2c4b5fe614705.jpeg"/></p>                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function ajaxComment(commentType,page){
        $.ajax({
            type : "GET",
            url:"/index.php?m=Home&c=goods&a=ajaxComment&goods_id=147&commentType="+commentType+"&p="+page,//+tab,
            success: function(data){
